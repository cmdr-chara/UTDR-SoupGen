...
Assert-Condition ($systemCreate -match 'soupy_popup\(welcome_items_, finish_welcome_, "Continue", 420, 170' -and $systemCreate -match 'new LuiButton\(\{ text: "Open Help Guide"' -and $systemCreate -notmatch 'soupy_message\(txt_, "Open Help Guide"') 'First-run onboarding is still blocking dismissal behind the Help Guide action'
