...
function LuiStyle(_style = {}) constructor {
	...
	color_scroll_track = _style[$ "color_scroll_track"] ?? undefined;
	color_scroll_thumb = _style[$ "color_scroll_thumb"] ?? undefined;
	color_scroll_thumb_active = _style[$ "color_scroll_thumb_active"] ?? undefined;
	toggle_slider_inset = _style[$ "toggle_slider_inset"] ?? 0;
