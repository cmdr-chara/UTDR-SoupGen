...
dllx double file_dropper_get_allow_raw() {
	// no buffer!
	return file_dropper_get_allow();
}

extern void file_dropper_set_allow(bool allow);
dllx double file_dropper_set_allow_raw(double _arg_allow) {
	// no buffer!
	file_dropper_set_allow((bool)_arg_allow);
	return 1;
}

extern double file_dropper_get_effect(int effect);
dllx double file_dropper_get_effect_raw(double _arg_effect) {
	// no buffer!
	return file_dropper_get_effect((int)_arg_effect);
}

extern double file_dropper_set_effect(int effect);
dllx double file_dropper_set_effect_raw(double _arg_effect) {
	// no buffer!
	return file_dropper_set_effect((int)_arg_effect);
}

extern bool file_dropper_get_default_allow();
dllx double file_dropper_get_default_allow_raw() {
	// no buffer!
	return file_dropper_get_default_allow();
}

extern void file_dropper_set_default_allow(bool allow);
dllx double file_dropper_set_default_allow_raw(double _arg_allow) {
	// no buffer!
	file_dropper_set_default_allow((bool)_arg_allow);
	return 1;
}

extern double file_dropper_get_default_effect(int effect);
dllx double file_dropper_get_default_effect_raw(double _arg_effect) {
	// no buffer!
	return file_dropper_get_default_effect((int)_arg_effect);
}

extern double file_dropper_set_default_effect(int effect);
dllx double file_dropper_set_default_effect_raw(double _arg_effect) {
	// no buffer!
	return file_dropper_set_default_effect((int)_arg_effect);
}
